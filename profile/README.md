...
<!-- ======================================================== -->
<p align="center">
  <img src="logo(1).svg" width="780"  />
</p>

<p align="center" style="font-size: 1.2rem; color: #4B0082; font-family: 'Dancing Script', cursive; margin-top: -10px;">
  Инженерия · Энергетика · Big Tech
</p>

<!-- ======================================================== -->
<!--  БЕЙДЖИ СТАТУСА (замените ссылки и названия)              -->
<!-- ======================================================== -->
<p align="center">
  <a href="https://github.com/port-23">
    <img src="https://img.shields.io/badge/Организация-Port%2023-4B0082?style=for-the-badge&logo=github" alt="Organization" />
  </a>
  <a href="https://github.com/port-23/.github/blob/main/LICENSE">
    <img src="https://img.shields.io/badge/License-NC--OSL%20v1.0-blue?style=for-the-badge&logo=opensourceinitiative" alt="License" />
  </a>
  <img src="https://img.shields.io/badge/Status-Active-brightgreen?style=for-the-badge" alt="Status" />
  <a href="https://github.com/sponsors/port-23">
    <img src="https://img.shields.io/badge/Sponsor-Поддержать-ff69b4?style=for-the-badge&logo=githubsponsors" alt="Sponsor" />
  </a>
</p>
...
<div style="font-size: 16px; line-height: 1.8; color: #1a1a1a;">
  ...
  <p style="text-align: justify; margin-bottom: 20px;">
    <span style="font-size: 1.4rem; font-weight: 700; color: #4B0082;">🚀 Кто мы</span><br />
    <strong style="color: #4B0082;">Port 23</strong> — это не просто компания или проект. Это технологическая гавань, где молодые, дерзкие и талантливые умы находят свою стихию. Мы — команда инженеров, исследователей и предпринимателей, объединённых одной страстью: превращать сложные задачи в элегантные решения.
  </p>
  ...
  <!-- ====== НАПРАВЛЕНИЯ ====== -->
  <h3 style="color: #4B0082; margin-top: 0;">🧭 Направления деятельности</h3>
  <p style="text-align: justify; margin-bottom: 15px;">
    Мы действуем на пересечении трёх ключевых технологических областей, каждая из которых является вызовом для целых отраслей:
  </p>
  <ul style="list-style-type: '⚡ '; padding-left: 20px; margin-bottom: 20px; color: #2c3e50;">
    <li>
      <strong style="color: #4B0082;">Индустриальные технологии</strong> – автоматизация производств, промышленная робототехника, IIoT. Помогаем заводам стать «умными», сокращая простои и повышая эффективность.
    </li>
    <li>
      <strong style="color: #4B0082;">Энергетика</strong> – умные энергосети, управление распределённой генерацией, интеграция возобновляемых источников, оптимизация потребления. Делаем энергию доступной, экологичной и управляемой.
    </li>
    <li>
      <strong style="color: #4B0082;">Big Tech</strong> – искусственный интеллект, машинное обучение, большие данные, облачные платформы. Создаём сервисы, которые анализируют, прогнозируют и автоматизируют — от рекомендаций до предиктивной аналитики.
    </li>
  </ul>

  <!-- ====== МИССИЯ ====== -->
  <h3 style="color: #4B0082;">🎯 Наша миссия</h3>
  <p style="text-align: justify; margin-bottom: 15px;">
  ...
  <div style="background: #eef2f6; border-radius: 10px; padding: 20px 25px; margin: 20px 0 25px 0; border-left: 6px solid #4B0082;">
    <p style="margin: 8px 0; font-weight: 500;">— Как сделать производство гибким и безлюдным?</p>
    <p style="margin: 8px 0; font-weight: 500;">— Как балансировать энергосистему с сотнями тысяч распределённых источников?</p>
    <p style="margin: 8px 0; font-weight: 500;">— Как извлечь ценные инсайты из терабайт неструктурированных данных?</p>
  </div>

  <!-- ====== ФИЛОСОФИЯ ====== -->
  <h3 style="color: #4B0082;">⚡ Наш дух и философия</h3>
  <p style="text-align: justify; margin-bottom: 15px;">
  ...
  <p style="text-align: justify; margin-bottom: 15px;">
    Мы открыты для сотрудничества, контрибьюции и спонсорства. Если вы разделяете наши ценности и хотите влиять на будущее технологий – мы ждём вас!
  </p>
  <ul style="list-style-type: '✅ '; padding-left: 20px; margin-bottom: 15px;">
    <li><strong>Разработчики</strong> – участвуйте в наших open source проектах.</li>
    <li><strong>Исследователи</strong> – предлагайте новые идеи и подходы.</li>
    <li><strong>Компании</strong> – становитесь партнёрами или спонсорами.</li>
  </ul>
  ...
  <div style="background: linear-gradient(135deg, #f0edff 0%, #ffffff 100%); padding: 18px 22px; border-radius: 12px; border: 1px solid #d4c9f0; margin-top: 20px;">
    <p style="margin: 0; font-size: 17px; color: #2c3e50;">
      🚀 <strong style="color: #4B0082;">Port 23</strong> – место, где амбиции превращаются в технологии, а технологии меняют мир.
    </p>
  </div>
...
<ul style="font-size: 16px; line-height: 1.8; list-style-type: '✅ ';">
  <li><strong>Инновации без границ</strong> – мы не боимся выходить за рамки и пробовать новое.</li>
  <li><strong>Надёжность и качество</strong> – каждая строка кода и каждое решение проходят строгую проверку.</li>
  <li><strong>Открытость и сообщество</strong> – мы делимся знаниями и вдохновляем других.</li>
  <li><strong>Экологичность и устойчивость</strong> – наши технологии направлены на бережное отношение к ресурсам.</li>
  <li><strong>Постоянное развитие</strong> – мы учимся каждый день и адаптируемся к изменениям.</li>
</ul>
...
<p align="left">
  ...
  <a href="mailto:hello@port23.io">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
  </a>
  <a href="https://linkedin.com/company/port23">
